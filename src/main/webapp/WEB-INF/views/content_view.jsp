...
function getAjaxList() {
	...
	$.ajax({
	    url: url,
	    type: 'GET',
	    cache: false,// 이걸 안쓰거나 true하면 수정해도 값반영이 잘안 때가 있음
	    dataType: 'json',
...
<script type="text/javascript">
	$(document).ready(function (){
		$('#a-delete').click(function(event) {
			...
			$.ajax({
			    type : "DELETE",
			    url : "${pageContext.request.contextPath}/restful/delete/" + "${content_view.bId}",
...
<body>
	...
	<table id="list-table" width="500" cellpadding="0" cellspacing="0" border="1">
		<form action="modify" method="post">
			...
			<tr >
				<td colspan="2"> <input type="submit" value="수정"> &nbsp;&nbsp; <a href="list">목록보기</a> &nbsp;&nbsp; <a id="a-delete" href="${pageContext.request.contextPath}/restful/delete?bId=${content_view.bId}">삭제</a> &nbsp;&nbsp; <a href="reply_view?bId=${content_view.bId}">답변</a></td>
			</tr>
		</form>
	</table>
